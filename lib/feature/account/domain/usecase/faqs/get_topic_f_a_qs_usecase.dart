...
class GetTopicFAQsUsecase {
  final FAQsRepositories faQsRepositories;
  GetTopicFAQsUsecase(this.faQsRepositories);
  Future<Either<Failure, List<FAQsEntity>>> call(String topic) async {
    return await faQsRepositories.getTopicFAQs(topic);
  }
}
